...
public class DataDao extends AbstractDao<Data, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Now = new Property(2, String.class, "now", false, "NOW");
    };
    ...
    public Data readEntity(Cursor cursor, int offset) {
        Data entity = new Data( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // now
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Data entity, int offset) {
        ...
        entity.setNow(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
